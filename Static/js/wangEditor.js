(function(factory) {
    ...
    _e(function(E, $) {
        ...
        Txt.fn.initHeight = function() {
            ...
            // 限制最小为 50px
            txtHeight = txtHeight < 300 ? 300 : txtHeight;
        ...
        E.plugin(function() {
            ...
            fns.onload || (fns.onload = function(resultText, xhr) {
                ...
                if (resultText.indexOf('error|') === 0) {
                    ...
                    resultText = JSON.parse(resultText).FullPath;
                    resultText = 'http://szdq.losta.net/' + resultText;
        ...
        E.plugin(function() {
            ...
            editor.xhrUploadImg = function(opt) {
                ...
                function timeoutCallback() {
                    ...
                    console.log(timeoutfn.call(editor, xhr));
